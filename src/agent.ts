...
export function createCrmAgent(surface: AgentSurface = "cli"): DeepAgent {
  ...
  return createDeepAgent({
    ...
    systemPrompt:
      ...
      "For /api/Leads/List, the tool already returns the newest 20 leads by CreateDate unless you set resultLimit or another result sort. Use its _result metadata for the full matching count and truncation status; do not delegate simple lead sorting or inspect an offloaded result file. " +
