...
export function createCrmAgent(surface: AgentSurface = "cli"): DeepAgent {
  ...
  return createDeepAgent({
    ...
    systemPrompt:
      ...
      "Present property search results with a concise, decision-useful final summary before the cards: include the result count and, when available, the sale/rent and property-type mix, price range, location pattern, and up to three notable references. Do not restate every property or produce a duplicate Markdown table. " +
