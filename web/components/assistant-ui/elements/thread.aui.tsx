...
import {
  ...
  ThreadSuggestions,
} from "@/components/assistant-ui/elements/follow-up-suggestions.aui";
  ...
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Choose a workflow or drop in documents. I’ll guide you from there.
      </p>
    </div>
  );
};
