...
// The gateway provides list/create/switch; rename/archive/delete are not exposed.
export const ThreadListItem: FC = () => (
  <ThreadListItemPrimitive.Root
    data-slot="aui_thread-list-item"
    className="group hover:bg-muted data-active:bg-muted relative flex h-8 items-center rounded-md transition-colors"
  >
    ...
    >
      <AuiIf condition={(s) => s.threadListItem.isRunning}>
        <Loader2Icon
          aria-label="Running"
